  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-6 md:py-8 md:ml-60" id="heb-portal">
      ...
      <header className="mb-8">
        <p className="script-hebrew text-2xl mb-3 text-center" lang="he" dir="rtl">בְּרֵאשִׁית בָּרָא אֱלֹהִים אֵת הַשָּׁמַיִם וְאֵת הָאָרֶץ</p>
